...
export default function ScalesIllustration({ className = "" }) {
    ...
    // Mouse movement track karke tilt angle calculate karne ke liye
    useEffect(() => {
        const handlePointerMove = (event) => {
            ...
            const nextTilt = normalizedX * 15; // Max tilt angle
            setTilt(nextTilt);
        };

        const handlePointerLeave = () => setTilt(0); // Mouse hatne par wapas seedha
    ...
    // Smooth transition physics ke liye
    const springTransition = "transform 350ms cubic-bezier(0.25, 1, 0.5, 1)";

    return (
        <div
            ref={containerRef}
            className={`relative flex items-center justify-center cursor-ew-resize ${className}`}
        >
            <svg
                viewBox="0 0 360 400"
                fill="none"
            ...
            >
                ...
                <g filter="url(#scale-shadow)">
                    ...
                    >
                        ...
                        <g
                            style={{
                                transform: `rotate(${-tilt}deg)`, /* Counter-rotation to stay vertical */
                        ...
                        >
                            <g filter="url(#pan-shadow)">
                                ...
                                {/* 3D Bowl */}
                                <path d="M40 160 Q40 156 45 156 L111 156 Q116 156 116 160 Q116 178 100 192 Q90 200 78 201 Q66 200 56 192 Q40 178 40 160 Z" fill="url(#pan-bowl-outer)" stroke="#5c4726" strokeWidth="1.6" />
                                <path d="M46 160 Q46 158 49 158 L107 158 Q110 158 110 160 Q110 174 97 186 Q88 193 78 194 Q68 193 59 186 Q46 174 46 160 Z" fill="url(#pan-bowl-inner)" opacity="0.9" />
                        ...
                        >
                            <g filter="url(#pan-shadow)">
                                ...
                                {/* 3D Bowl */}
                                <path d="M244 160 Q244 156 249 156 L315 156 Q320 156 320 160 Q320 178 304 192 Q294 200 282 201 Q270 200 260 192 Q244 178 244 160 Z" fill="url(#pan-bowl-outer)" stroke="#5c4726" strokeWidth="1.6" />
                                <path d="M250 160 Q250 158 253 158 L311 158 Q314 158 314 160 Q314 174 301 186 Q292 193 282 194 Q272 193 263 186 Q250 174 250 160 Z" fill="url(#pan-bowl-inner)" opacity="0.9" />
                    ...
                    {/* ================= BASE ================= */}
                    <path d="M143 293 Q180 281 217 293 L233 318 Q180 332 127 318 Z" fill="url(#base-gradient)" />
                    <path d="M127 318 Q180 332 233 318 L248 332 Q180 349 112 332 Z" fill="url(#pan-bowl-outer)" stroke="#3a2c18" strokeWidth="1.8" />
